...
const clothesTypes = [
  ...
  { label: 'Shirts and Blouses', value: 'Shirts and Blouses' },
  { label: 'Tops', value: 'Tops' },
  { label: 'Pants and Trousers', value: 'Pants and Trousers' },
  ...
  { label: 'Plus-size Clothing', value: 'Plus-size Clothing' },
  { label: 'Ethnic Clothing', value: 'Ethnic Clothing' },
  { label: 'Accessories', value: 'Accessories' },
];
